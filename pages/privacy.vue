<template>
  ...
  <div class="flex justify-center">
    <div class="flex flex-col items-center space-y-4">
      <h3 class="text-2xl font-semibold">Privacy Policy</h3>
      <div
      ...
      >
        ...
        <div>
          <p>
            ...
            recorded by Code Streaks and how we use it.
          </p>
          <p>
        ...
        <div>
          <P
            ...
            the advertising partners of Code Streaks.</P
          >
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Code Streaks,
          ...
          <p>
            Note that Code Streaks has no access to or control over these
        ...
        <div>
          ...
          <p>
            Code Streaks does not knowingly collect any Personal Identifiable
        ...
        <div>
          <p>
            ...
            that they shared and/or collect in Code Streaks. This policy is not
