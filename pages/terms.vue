<template>
  <Head>
    <Title>Code Streaks | Terms of service</Title>
  </Head>
  <div class="flex justify-center">
    <div class="flex flex-col items-center space-y-4">
      <h2 class="text-2xl font-semibold">Terms of service</h2>
      <div
      ...
      >
        ...
        <div>
          <p>
            ...
            use of Code Streaks's Website, located at https://codestreaks.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Code Streaks if you do not agree
        ...
        <div>
          <p>
            ...
            to use cookies in agreement with the Code Streaks's Privacy Policy.
          </p>
          <p>
        ...
        <div>
          <p>
            ...
            intellectual property rights for all material on Code Streaks. All
            intellectual property rights are reserved. You may access this from
            Code Streaks for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from Code Streaks</li>
            <li>Sell, rent or sub-license material from Code Streaks</li>
            <li>Reproduce, duplicate or copy material from Code Streaks</li>
            <li>Redistribute content from Code Streaks</li>
          </ul>
          <p>
          ...
          <p>
            ...
            Code Streaks does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Code Streaks,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Code
            Streaks shall not be liable for the Comments or for any liability,
          ...
          <p>
            Code Streaks reserves the right to monitor all Comments and to
          ...
          <p>
            You hereby grant Code Streaks a non-exclusive license to use,
        ...
        <div>
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Code Streaks;
          ...
          <p>
            ...
            sending an e-mail to Code Streaks. Please include your name, your
          ...
          <p>
            No use of Code Streaks's logo or other artwork will be allowed for
